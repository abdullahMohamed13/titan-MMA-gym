...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const setupLenis = useCallback(() => {
    ...
    try {
      // Check if there's already a global Lenis instance and temporarily disable it
      ...
      console.error('Failed to initialize Lenis in ScrollStack:', error);
      return null;
    }
  }, [handleScroll]);
  ...
  useLayoutEffect(() => {
    ...
    return () => {
      ...
      // Restore global Lenis instance if it exists
      const globalLenis = (window as any).__lenis;
      if (globalLenis) {
        globalLenis.start();
      }
