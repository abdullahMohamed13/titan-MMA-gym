...
export default function SellingPoints() {
  const sellingPoints = [
    {
      icon: '/images/icons/boxing-glove.png',
    ...
    {
    	icon: '/images/icons/role-model.png',
    ...
    {
    	icon: '/images/icons/number-1.png',
          ...
          {sellingPoints.map((point, index) => (
            ...
            >
              <Box sx={{ mb: 3, display: 'flex', justifyContent: 'center' }}>
              	<img src={point.icon} className='h-10 w-10 object-contain' alt={point.title} />
              </Box>
              ...
              <Typography
                ...
                sx={{
                  fontWeight: 700,
									mb: 2,
									background: 'linear-gradient(45deg, #e20000, #f1c40f)',
                  backgroundClip: 'text',
